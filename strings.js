export const strings = {
	en: {
		...
		messaging: 'Pareto Instant Messaging (Group)',
		...
		homeSecond:
			'Here you (and your mentor) can add notes about how your learning is progressing, as well as simply a place for reminders, things to study, etcetera. In the future, this will be expanded to have real-time saving, as well as rich text functionality within a "Daily Journal" context.',
		homeThird:
	...
	es: {
		...
		messaging: 'Mensajería Instantánea de Pareto',
		...
		homeSecond:
			'Aquí tú (y tu mentor) pueden agregar notas sobre cómo estás progresando en tu aprendizaje, así como simplemente un lugar para recordatorios, cosas para estudiar, etcétera. En el futuro, esto se ampliará para tener un ahorro en tiempo real, así como un "Diario" donde podrás llevar un detallado registro de tus avances',
		homeThird:
...
Ug: {
	...
	homeSecond:
		"Wano gwe wamu n'omusomesa wo, wemusobolela okulanga engeri ensoma yo wetambula, ekisobola obeela ekifo wemuteeka olukala lwe bintu eby'okusoma.Mu maaso, kino kijja kugayizibwa obeeele ngo'sobola oseevinga esomo lyo mubuliwo, wamo n'okubeela n'enyukutta eziwelaako",
	homeThird:
