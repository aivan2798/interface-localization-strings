export const strings = {
	en: {
		...
		projects: 'Projects ni',
		projectName: 'nying Project',
		...
		save: 'kan',
		githubRepository: 'Repository ni mi Github',
		...
		noDrinking: 'pi mat kong i diwo mi ninu tec',
		noDrinkingSummary:
		...
		secondFrogSummary:
			'There is an item that is second in importance, after eating the frog. Have you finished it?',
	...
	ac: {
		...
		thirdLanding: 'No ngec mi tiyu ki jemi mapatpat make yubu plogram mi computer, yubi product ni macel ma kabeddu i portfolio ni, ki bene kwan pwony ma pire tek tutwal i tic mi computer science irom karu peny mi ikom computer maber.'
		//profile
		saving: 'Ti gwoko...',
		saveProfile: 'Gwok Profile ni',
		firstName: 'nying me din',
		...
		noIdeasYet: 'Pud pi coyo tam ni ikom plojec? Tim ber i di bok ma piny ni ka coyo mo.',
		noProjectsYet: 'Pud pi cagu tiyu ikom plojec? Tim ber i di piny kenyu ka keddu mo.',
		...
		trashTalkPSA: 'Man pire pe tek: lok ma tidi. Cwal lok mo matweru talu nyo cubu cwiny jo ma iti pyem kwedgi.',
		viewProof: 'Nen caden',
		...
		flashcards: "Kad 52, ma konyi ngeyu jemi madwong ikun JavaScript ki API ne madwong.",
		stickers: 'Workflow stickers, ma konyi maku terminal commands mi Git ma piretek, AWS Amplify ki Bash iyoroyoro.',
		workbooks:
			'Interactive, physical workbook to help you ideate your capstone portfolio project/product, design wireframe mockups, model the information to store in your database, create an architecture diagram, and more.',
		support: 'Priority support & first access to new features.',
		...
		morningSummary:'cak nino ni ki mit matir - co jemi matima tyen ma ariyo, pwony loku maber ki jo ducu ki bene nyudi maa ki pwoc. Cam dek ki bene tim excercise.',
		...
		meditation: 'Meditation',
		meditationSummary: 'I kine akanyu cawa abiru nyo aboru no ityeko cam dek, ibedi peny iling ki wiyi wukut yamu. Timu kumeno kakonyi medu twe tic ni.',
		...
		consistencyTitle: 'Consistency is King',
		consistencySummary: 'Yin co nino ki nino i cawa marom, ki i check-in ki app mi Pareto no dakika abic pukaru.',
		...
		homeFirst: 'Ki kanyi, itwero loku nyiyi, cal ni ki lok ma loku ikomi ma danu ka nenu.',
		homeThird:
